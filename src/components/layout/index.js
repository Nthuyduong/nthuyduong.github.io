...
const Layout = ({ children }) => {
  ...
  const withoutElement = [ROUTER.ALIO, ROUTER.CAKE, ROUTER.AGURI, ROUTER.FASHION, ROUTER.BEAUTYBLOG, ROUTER.PROJECT_DETAIL, ROUTER.WORKOUT, ROUTER.ARCHITEC, ROUTER.SCHEDULE, ROUTER.SHORT];
