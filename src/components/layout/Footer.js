...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    return (
      <div className=" py-[30px] border-t border-solid border-[#ccc] mt-8">
        <div className="section">
          <div className="flex flex-col-reverse gap-4 sm:grid sm:grid-cols-12 items-center">
            <div className="text-center col-span-8">
              ...
              <p className="pt-3">Follow on <a href="https://www.behance.net/gallery/174317119/Thuy-Duongs-Portfolio/modules/984307513" target="_blank">Behance</a></p>
            </div>
            <div className="block sm:hidden border-b border-solid border-[#ccc] w-[30%]"></div>
            <div className="text-center col-span-4 body_text cursor-text-wrp">
